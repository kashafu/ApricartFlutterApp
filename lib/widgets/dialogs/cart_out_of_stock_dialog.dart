...
class CartOutOfStockDialog extends StatelessWidget {
  const CartOutOfStockDialog({Key? key}) : super(key: key);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Few items are not available for ${locator<DataService>().homeDataType}. Please replace or remove them to continue.',
